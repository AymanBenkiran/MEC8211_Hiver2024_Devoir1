...
Entrees : 
    - prm_prob : Objet qui contient les parametres du probleme
        ...
        - d_eff : Coefficient de diffusion effectif de sel dans le beton [m^2/s]
...
def analytique(prm_prob, mesh):
    c = [0.25*prm_prob.s/prm_prob.d_eff * prm_prob.r**2 * (r**2/prm_prob.r**2 - 1) + prm_prob.ce for r in mesh]
    return c
